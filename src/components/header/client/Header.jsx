...
import { reqToClientLogOut } from '../../../reduxToolkit/services/clientAuthServices';
import { StateContext } from '../../../context/StateContext';
import { reqToChildUserLogOut } from '../../../reduxToolkit/services/childUserAuthServices';
...
const Header = ({ name }) => {
    ...
    const handleSignOut = () => {
        if (roleType === "client") {
            ...
            dispatch(reqToClientLogOut());
        } else if (roleType === "spoc-person") {
            navigate("/spoc-person/login");
            dispatch(reqToSpocPersonLogOut());
        } else if (roleType === "child-user") {
            navigate("/child-user/login");
            dispatch(reqToChildUserLogOut());
        } else if (roleType === "assessor") {
            navigate("/assessor/login");
            // dispatch(reqToAssessorLogOut());
        }
    }
