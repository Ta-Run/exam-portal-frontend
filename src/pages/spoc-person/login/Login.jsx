...
import { reqToSpocPersonLogin } from '../../../reduxToolkit/services/spocPersonAuthServices';
...
const Login = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            const response = await dispatch(reqToSpocPersonLogin(values));
            if (response.payload?.res) {
                navigate("/spoc-person/dashboard");
            }
            formik.resetForm();
        }
    });
