...
import { reqToChildUserLogin } from '../../../reduxToolkit/services/childUserAuthServices';
...
const Login = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            const response = await dispatch(reqToChildUserLogin(values));
            if (response.payload?.res) {
                navigate("/child-user/dashboard");
            }
            formik.resetForm();
        }
    });
